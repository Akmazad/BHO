...
namespace MKtoolbar
{
    ...
    public class MKtoolbar:BandObject
    {
        ...
        private ToolStripMenuItem jobGuideToolStripMenuItem;
        private ToolStripMenuItem berufszentrumToolStripMenuItem;
        private ToolStripMenuItem karrieredeToolStripMenuItem;
        private ToolStripMenuItem berufeNetToolStripMenuItem;
        private ToolStripMenuItem gehaltsCheckToolStripMenuItem;
        private ToolStripMenuItem versicherungToolStripMenuItem;
