...
namespace MKtoolbar.BHO
{
    [ComVisible(true)]
    [Guid("FD970ED5-3EDA-438d-BFFD-715931E2775B")]
    [ClassInterface(ClassInterfaceType.None)]

    class MKtoolbarBHO:IObjectWithSite
    {
        #region Fields
        ...
        public static void RegisterBHO(Type t)
        {
            ...
            string _VersionName = "MKversionNumber";

            object _value = (object)1;
            object _VersionNumber = (object)0.1;

            bhoKey.SetValue(_name, _value);
            bhoKey.SetValue(_VersionName, _VersionNumber);
